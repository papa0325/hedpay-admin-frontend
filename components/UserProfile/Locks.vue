    ...
    <div>
      ...
      >
        <el-table :data="queriedData">
          ...
          <el-table-column
            min-width="180"
            :label="this.$t('management.user-info.locks.table.banStart')"
          >
            <div
              slot-scope="{ row }"
            >
          ...
          <el-table-column
            min-width="180"
            :label="this.$t('management.user-info.locks.table.banEnd')"
          >
            <div
              slot-scope="{ row }"
            >
  ...
  data() {
    return {
      ...
      tableColumns: [
        {
          prop: 'type',
          label: this.$t('management.user-info.locks.table.lockType'),
          minWidth: 100,
        },
        {
          prop: 'banComment',
          label: this.$t('management.user-info.locks.table.comment'),
          minWidth: 200,
        },
      ],
      tableData: [],
  ...
  methods: {
    ...
    async getLocks() {
      ...
      if (this.oldModel.currentPage !== (this.pagination.currentPage - 1) * this.pagination.perPage
        ...
        try {
          const response = await this.$api.getLocks(this.$route.params.index, (this.pagination.currentPage - 1) * this.pagination.perPage, this.pagination.perPage);
